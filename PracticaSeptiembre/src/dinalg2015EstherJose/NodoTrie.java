/**
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * $Id: NodoTrie.java,v 1.19 2008/09/30 16:07:00 alf-mora Exp $
...
public class NodoTrie<T> implements Serializable
{
    ...
    /**
     * Sub�rbol correspondiente al hermano derecho del nodo actual
     */
    ...
    /**
     * Ingresa el elemento dado asociado con la palabra especificada en el trie del que el nodo actual es la ra�z. <br>
     * <b> pre: </b> palabra!=null, elem!=null<br>
     * <b> post: </b> Se insert� el elemento asociado con la palabra especificada en el trie.
     * @param palabra Palabra con la que est� asociada el elemento
     * @param elem El elemento a ser insertado
     * @return El n�mero de nuevos nodos adicionados
     * @throws ElementoExisteException Si el elemento a ser insertado ya existe en el trie
     */
    public int insertar( String palabra, T elem ) throws ElementoExisteException
    {
        ...
        {
            throw new ElementoExisteException( "El elemento que se quiere ingresar ya existe en el trie" );
        }

        int elementosInsertados = 0;
        char nCaracter = palabra.charAt( 0 );

        if( izqNodo != null && izqNodo.caracter == nCaracter )// Si el car�cter del hijo izquierdo es igual al que se quiere insertar
        {
            if( palabra.length( ) != 1 )
                return izqNodo.insertar( palabra.substring( 1 ), elem );// El hijo izquierdo es responsable de insertar el nuevo elemento
            else
                izqNodo.elemento = elem;// Se agreg� un prefijo de una palabra existente
        }
        else if( izqNodo != null && izqNodo.caracter > nCaracter )
        {
            ...
            // El car�cter a insertar deber�a ser el nuevo hijo izquierdo del nodo actual
        ...
        else if( izqNodo != null && izqNodo.hermanoDerNodo != null )// Se debe agregar el nodo sobre los hermanos del nodo actual
        {
            ...
            if( iterador != null && iterador.caracter == nCaracter )// Encontr� el nodo que deba agregar el resto de la palabra
            {
                if( palabra.length( ) == 1 )
                {
    ...
    /**
     * Elimina la palabra del trie del que el nodo actual es ra�z. <br>
     * <b> pre: </b> palabra!=null, longitud palabra es mayor a cero. <br>
     * <b> post: </b> Se elimino la palabra si esta exist�a en el trie. Si la palabra no existe se retorna false.
    ...
    {
        int eliminados = 0;
        char c = palabra.charAt( 0 ); // Primer car�cter de la palabra

        if( izqNodo != null && izqNodo.caracter == c ) // S�lo se contin�a la eliminaci�n si el primer car�cter de la palabra es igual al del nodo actual
        {
            if( palabra.length( ) > 1 )
            {
    ...
    /**
     * Busca el elemento del trie cuya representaci�n en String corresponde a una palabra dada. <br>
    ...
    /**
     * Retorna la altura del trie del que el nodo actual es ra�z. <br>
     ...
     * <b>post: </b> Se retorn� el hermano derecho del nodo.
    ...
    /**
     * Retorna el car�cter del nodo. <br>
     * <b>post: </b> Se retorn� el car�cter del nodo.
     * @return Car�cter del nodo
     */
    ...
    /**
     * Retorna los elementos que se encuentran en el trie, siendo la ra�z el nodo actual. <br>
     * <b> pre: </b> lista!= null. <br>
     * <b> post: </b> La lista contiene los elementos del nodo del trie cuyo ra�z es el nodo actual
     * @param lista La lista en la que se van a adicionar los elementos
     */
