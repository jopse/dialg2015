...
public class TrieNode<T> implements Serializable
{
     ...
     * Subárbol izquierdo
     */
    private TrieNode<T> izqNodo;

    /**
     * Subárbol correspondiente al hermano derecho del nodo actual
     */
    private TrieNode<T> hermanoDerNodo;
     ...
     */
    public TrieNode( char carac, T elem )
    {
	caracter = carac;
	izqNodo = null;
	hermanoDerNodo = null;
	...
	{
	    TrieNode<T> nuevoNodo = null;
	    if( palabra.length( ) == 1 )
	    {
		nuevoNodo = new TrieNode<T>( nCaracter, elem );
	    }
	    else
	    {
		nuevoNodo = new TrieNode<T>( nCaracter );// Nodo solo con el caracter
	...
	else if( izqNodo != null && izqNodo.hermanoDerNodo != null )// Se debe agregar el nodo sobre los hermanos del nodo actual
	{
	    ...
	    TrieNode<T> iterador = izqNodo.hermanoDerNodo;
	    TrieNode<T> anterior = izqNodo;
	...
	else if( izqNodo != null && izqNodo.caracter < c && izqNodo.hermanoDerNodo != null ) // Buscar si la palabra existe en otro nodo a la derecha y eliminarla
	{
	    ...
	    TrieNode<T> hermanoIzquierdo = izqNodo;
	    TrieNode<T> nodo = izqNodo.hermanoDerNodo;
     ...
     */
    public TrieNode<T> darHijoIzquierdo( )
    {
	return izqNodo;
    }
     ...
     */
    public TrieNode<T> darHermanoDerecho( )
    {
	...
	if( izqNodo != null )
	{
	    ...
	    TrieNode<T> aux = izqNodo.hermanoDerNodo;
	    while( aux != null )
	    {
